...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('saaskit_userprofile', (
            ('id', orm['saaskit_profile.UserProfile:id']),
            ('user', orm['saaskit_profile.UserProfile:user']),
            ('real_name', orm['saaskit_profile.UserProfile:real_name']),
            ('about', orm['saaskit_profile.UserProfile:about']),
            ('is_public', orm['saaskit_profile.UserProfile:is_public']),
        ))
        db.send_create_signal('saaskit_profile', ['UserProfile'])
