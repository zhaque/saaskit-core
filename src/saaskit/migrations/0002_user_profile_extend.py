...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.add_column('saaskit_userprofile', 'website', orm['saaskit.userprofile:website'])
        
        # Adding field 'UserProfile.company_url'
        db.add_column('saaskit_userprofile', 'company_url', orm['saaskit.userprofile:company_url'])
        
        # Adding field 'UserProfile.location'
        db.add_column('saaskit_userprofile', 'location', orm['saaskit.userprofile:location'])
